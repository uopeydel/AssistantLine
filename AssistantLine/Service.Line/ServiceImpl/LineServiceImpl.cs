...
{
    public class LineServiceImpl : ILineServiceInf
    {
        ...
        public byte[] GetUserUploadedContent(string ContentID)
        {
            try
            {
                ...
                webClient.Headers.Add("Authorization", "Bearer " + connect.TakeConnection().ChannelAccessToken);
